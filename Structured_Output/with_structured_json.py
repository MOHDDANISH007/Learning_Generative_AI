...
json_schema = {
    ...
    "properties":{
        ...
        "Technologies":{
            ...
            "description":"The technologies used in this field"
        },
        "Advantages":{
            "type":"array",
            "items":{
            ...
            "description":"The advantages of the product"
        },
        "Disadvantages":{
            "type":"array",
            "items":{
            ...
            "description":"The disadvantages of the product"
        },
        "sentiment":{
            "type":"string",
        ...
        "Code":{
            "type":"string",
            "description":"The code of the review"
        }
    }
}
